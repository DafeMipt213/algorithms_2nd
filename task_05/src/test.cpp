...
TEST(RMQ, Easy) {
  ...
  RMQ rmq(vec);
  ASSERT_EQ(rmq.findMin(1, 7).value, 1);
}
TEST(RMQ, Medium) {
  std::vector<int> vec{1, 10, 7, 6, 3, 2, 1, 11};
  RMQ rmq(vec);
  ASSERT_EQ(rmq.findMin(6, 7).value, 1);
}
TEST(RMQ, Hard) {
  std::vector<int> vec{1, 10, 7, 6, 3, 2, 1, 11};
  RMQ rmq(vec);
  ASSERT_EQ(rmq.findMin(3, 4).value, 3);
}
TEST(RMQ, Harder) {
  std::vector<int> vec{1, 10, 7, 6, 3, 2, 1, 11, 12};
  RMQ rmq(vec);
  ASSERT_EQ(rmq.findMin(7, 8).value, 11);
}
TEST(RMQ, Comlicated) {
  std::vector<int> vec{1, 10, 7, 6, 3, 2, 1, 11, 12, 1, 1, 1};
  RMQ rmq(vec);
  ASSERT_EQ(rmq.findMin(1, 11).value, 1);
}
TEST(RMQ, One_Element) {
  std::vector<int> vec{1, 10};
  RMQ rmq(vec);
  ASSERT_EQ(rmq.findMin(1, 1).value, 10);
}
TEST(RMQ, Big_Vector) {
  std::vector<int> vec{1, 10, -1, 2, 3, 5, -6, -7, 8, 10, 10, 2,  3, 4, 1,
                       2, 4,  2,  1, 2, 3, 4,  4,  3, 1,  10, -1, 1, 1, -1};
  RMQ rmq(vec);
  ASSERT_EQ(rmq.findMin(5, 11).value, -7);
}
...
TEST(RMQ, Big_Vector_All_Elements) {
  std::vector<int> vec{1, 10, -1, 2, 3, 5, -6, -7, 8, 10, 10, 2,  3, 4, 1,
                       2, 4,  2,  1, 2, 3, 4,  4,  3, 1,  10, -1, 1, 1, -1};
  RMQ rmq(vec);
  ASSERT_EQ(rmq.findMin(0, 29).value, -7);
}
